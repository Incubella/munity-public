...
export default function Usernavigation(props) {
  ...
  // Find the index of the first active tab
  const firstActiveTabIndex = navTabs.findIndex((tab) => tab.is_active);

  // Initialize the state with the index of the first active tab
  const [value, setValue] = useState(
    firstActiveTabIndex !== -1 ? firstActiveTabIndex : 0
  );
